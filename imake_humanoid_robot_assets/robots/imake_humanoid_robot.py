...
IMAKE_HUMANOID_ROBOT_LEG_JOINTS = [
...
IMAKE_HUMANOID_ROBOT_ARM_JOINTS = [
...
IMAKE_HUMANOID_ROBOT_JOINTS = IMAKE_HUMANOID_ROBOT_ARM_JOINTS + IMAKE_HUMANOID_ROBOT_LEG_JOINTS

IMAKE_HUMANOID_ROBOT_BIPED_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"{ISAACLAB_ASSET_DIR}/robots/imake_humanoid_robot/imake_humanoid_robot/usd/imake_humanoid_robot_biped.usd",
...
"""Configuration for the iMake Humanoid Robot in bipedal mode."""

IMAKE_HUMANOID_ROBOT_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"{ISAACLAB_ASSET_DIR}/robots/imake_humanoid_robot/imake_humanoid_robot/usd/imake_humanoid_robot.usd",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
...
"""Configuration for the iMake Humanoid Robot."""
